...
--Employees_Salary(Employees_id, Salary_id)

select employee_name, monthly_salary from Employees_Salary
...
right join Employees_Salary on Employees.id = Employees_Salary.employees_id
join Salary on Salary.id = Employees_salary.salary_id
...
select employee_name, roles_name from employees
join roles_employees on employees.id = roles_employees.employees_id 
...
select employee_name, roles_name, monthly_salary from employees
...
select roles_name, monthly_salary from employees
join employees_salary on employees.id = employees_salary.employees_id
join salary on salary.id = employees_salary.salary_id 
join roles_employees on employees.id = roles_employees.employees_id 
join roles on roles.id = roles_employees.roles_id 
...
join roles_employees on employees.id = roles_employees.employees_id 
join roles on roles.id = roles_employees.roles_id 
where roles_name like '%Junior Python%';
...
join roles_employees on employees.id = roles_employees.employees_id 
join roles on roles.id = roles_employees.roles_id 
where roles_name like '%Middle%JavaScript%';
...
join roles_employees on employees.id = roles_employees.employees_id 
join roles on roles.id = roles_employees.roles_id 
where roles_name like '%Senior Java%';
...
join roles_employees on employees.id = roles_employees.employees_id 
join roles on roles.id = roles_employees.roles_id 
where roles_name like '%Junior%' and roles_name like '%QA%';
...
join roles_employees on employees.id = roles_employees.employees_id 
join roles on roles.id = roles_employees.roles_id 
where roles_name like '%JavaScript%';
...
select count(roles_name) from employees 
join roles_employees on employees.id = roles_employees.employees_id  
join roles on roles.id = roles_employees.roles_id 
where roles_name like '%QA%';
